...
<ol class="dd-list">
    {{#deptList}}
        <li class="dd-item dd2-item dept-name {{displayClass}}" id="dept_{{id}}" href="javascript:void(0)" data-id="{{id}}">
            <div id="test_{{id}}" class="dd2-content" style="cursor:pointer;">
            {{name}}
            &nbsp;
...
<script type="text/javascript">
    $(function () {
        ...
        var optionStr = '';
        var lastClickDeptId = -1; //最后点击的部门id
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.ret) {
                            ...
                            showMessage('获取用户分配的权限数据', result.msg, false);
                        }
                    }
                });
            });
